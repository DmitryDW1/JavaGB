...
public class Task3 {
     ...
     * @param str входная римская цифра
...
//    private static int translate2(Map<Character, Integer> characterIntegerMap, String str) {
//        int result2 = characterIntegerMap.get(str.charAt(str.length() - 1));
//        for (int i = 0; i < str.length() - 1; i++) {
//            if (characterIntegerMap.containsKey(str.charAt(i))){
//                if (characterIntegerMap.get(str.charAt(i)) < characterIntegerMap.get(str.charAt(i + 1))){
//                    result2 -= characterIntegerMap.get(str.charAt(i));
//                    }
//                } else {
//                    result2 += characterIntegerMap.get(str.charAt(i));
//                }
